...
public interface Viewable {
    /**
     * Checks whether the current viewable has been registered as a banned entity
     * @return True if the element is banned and False if the element is not banned
     */
    public abstract boolean isBanned();
    
    /**
     * Checks whether the current viewable is viewable to the world.
     * @return True if the viewable is a public resource and false if the viewable is private
     */
     ...
     * @param value True if the viewable is now banned and false if the viewable is unbanned
     ...
     * @param value True if the viewable is now public and false if the viewable is private
